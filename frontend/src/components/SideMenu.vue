...
const menuItems = [
  ...
  { id: 'schede', icon: 'fa fa-list', label: 'Programmi Allenamento', route: '/programmi', roles: [ROLES.PERSONAL_TRAINER,ROLES.CLIENTE] },
  { id: 'diario', icon: 'fa fa-book', label: 'Diario', route: '/diario', roles: [ROLES.CLIENTE] },
  { id: 'esercizi', icon: 'fa fa-tasks', label: 'Esercizi', route: '/esercizi', roles: [ROLES.PERSONAL_TRAINER] },
  { id: 'richieste-nutriz', icon: 'fa fa-apple', label: 'Richieste Nutrizione', route: '/richieste-nutrizione', roles: [ROLES.PERSONAL_TRAINER,ROLES.NUTRIZIONISTA] },
  { id: 'richieste-pt', icon: 'fa fa-calendar-times-o', label: 'Scadenze', route: '/scadenze', roles: [ROLES.PERSONAL_TRAINER] },
